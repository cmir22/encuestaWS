...
exports.toTitleCase = exports.maybeNodeArray = exports.isStringLiteralLike = exports.isBooleanLiteralLike = exports.isSameLine = exports.kebabToCamelCase = exports.getDeclaredAngularLifecycleMethods = exports.getLifecycleInterfaceByMethodName = exports.getDeclaredAngularLifecycleInterfaces = exports.getDeclaredInterfaceName = exports.getDeclaredInterfaceNames = exports.getDeclaredInterfaces = exports.isAngularLifecycleMethod = exports.isAngularLifecycleInterface = exports.isAngularInnerClassDecorator = exports.isAngularClassDecorator = exports.getSymbolName = exports.getPipeDecorator = exports.getNgModuleDecorator = exports.getInjectableDecorator = exports.getDirectiveDecorator = exports.getComponentDecorator = exports.getNextToLastParentNode = exports.getDecoratorPropertyInitializer = exports.getDecoratorName = exports.getDecoratorArgument = exports.getDecorator = exports.getClassName = exports.ANGULAR_CLASS_DECORATOR_LIFECYCLE_METHOD_MAPPER = exports.ANGULAR_LIFECYCLE_METHODS = exports.ANGULAR_LIFECYCLE_INTERFACES = exports.ANGULAR_CLASS_DECORATOR_MAPPER = exports.ANGULAR_CLASS_DECORATORS = exports.ANGULAR_INNER_CLASS_DECORATORS = exports.angularLifecycleMethodKeys = exports.angularLifecycleInterfaceKeys = exports.angularInnerClassDecoratorKeys = exports.angularClassDecoratorKeys = exports.AngularLifecycleMethods = exports.AngularLifecycleInterfaces = exports.AngularInnerClassDecorators = exports.AngularClassDecorators = void 0;
var typescript_1 = require("typescript");
var classDeclarationUtils_1 = require("./classDeclarationUtils");
...
exports.AngularInnerClassDecorators = __assign(__assign(__assign({}, AngularConstructorParameterDecorators), AngularMethodDecorators), AngularPropertyAccessorDecorators);
...
exports.angularClassDecoratorKeys = objectKeys_1.objectKeys(AngularClassDecorators);
exports.angularInnerClassDecoratorKeys = objectKeys_1.objectKeys(exports.AngularInnerClassDecorators);
exports.angularLifecycleInterfaceKeys = objectKeys_1.objectKeys(AngularLifecycleInterfaces);
exports.angularLifecycleMethodKeys = objectKeys_1.objectKeys(AngularLifecycleMethods);
...
exports.ANGULAR_CLASS_DECORATOR_LIFECYCLE_METHOD_MAPPER = new Map([
    [AngularClassDecorators.Component, exports.ANGULAR_LIFECYCLE_METHODS],
    [AngularClassDecorators.Directive, exports.ANGULAR_LIFECYCLE_METHODS],
    [AngularClassDecorators.Injectable, new Set([AngularLifecycleMethods.ngOnDestroy])],
...
exports.getDecoratorArgument = function (decorator) {
    ...
    if (!typescript_1.isCallExpression(expression) || !expression.arguments || expression.arguments.length === 0) {
        return undefined;
    }
    var args = expression.arguments[0];
    return typescript_1.isObjectLiteralExpression(args) && args.properties ? args : undefined;
};
exports.getDecoratorName = function (decorator) {
    var expression = decorator.expression;
    if (typescript_1.isIdentifier(expression))
        return expression.text;
    if (typescript_1.isCallExpression(expression) && typescript_1.isIdentifier(expression.expression)) {
        return expression.expression.text;
    }
    return undefined;
};
exports.getDecoratorPropertyInitializer = function (decorator, name) {
    var args = exports.getDecoratorArgument(decorator);
    if (!args || !typescript_1.isObjectLiteralExpression(args))
        return undefined;
    var properties = typescript_1.createNodeArray(args.properties);
    var property = properties.find(function (prop) { return !!(prop.name && typescript_1.isIdentifier(prop.name) && prop.name.text === name); });
    if (!property || !typescript_1.isPropertyAssignment(property))
        return undefined;
    return property.initializer;
};
exports.getNextToLastParentNode = function (node) {
...
exports.getComponentDecorator = function (node) { return exports.getDecorator(node, 'Component'); };
exports.getDirectiveDecorator = function (node) { return exports.getDecorator(node, 'Directive'); };
exports.getInjectableDecorator = function (node) { return exports.getDecorator(node, 'Injectable'); };
exports.getNgModuleDecorator = function (node) { return exports.getDecorator(node, 'NgModule'); };
exports.getPipeDecorator = function (node) { return exports.getDecorator(node, 'Pipe'); };
exports.getSymbolName = function (expression) {
    var childExpression = expression.expression;
    return typescript_1.isPropertyAccessExpression(childExpression) ? childExpression.name.getText() : childExpression.getText();
};
exports.isAngularClassDecorator = function (value) {
    return exports.ANGULAR_CLASS_DECORATORS.has(value);
};
exports.isAngularInnerClassDecorator = function (value) {
    return exports.ANGULAR_INNER_CLASS_DECORATORS.has(value);
};
exports.isAngularLifecycleInterface = function (value) {
    return exports.ANGULAR_LIFECYCLE_INTERFACES.has(value);
};
...
exports.getDeclaredAngularLifecycleInterfaces = function (node) {
    return exports.getDeclaredInterfaceNames(node).filter(exports.isAngularLifecycleInterface);
};
exports.getLifecycleInterfaceByMethodName = function (methodName) {
    return methodName.slice(2);
};
exports.getDeclaredAngularLifecycleMethods = function (node) {
    return classDeclarationUtils_1.getDeclaredMethods(node)
        .map(function (method) { return method.name.getText(); })
        .filter(exports.isAngularLifecycleMethod);
};
exports.kebabToCamelCase = function (value) { return value.replace(/-[a-zA-Z]/g, function (x) { return x[1].toUpperCase(); }); };
exports.isSameLine = function (sourceFile, pos1, pos2) {
    return typescript_1.getLineAndCharacterOfPosition(sourceFile, pos1).line === typescript_1.getLineAndCharacterOfPosition(sourceFile, pos2).line;
};
exports.isBooleanLiteralLike = function (node) {
    return node.kind === typescript_1.SyntaxKind.FalseKeyword || node.kind === typescript_1.SyntaxKind.TrueKeyword;
};
exports.isStringLiteralLike = function (node) {
    return typescript_1.isStringLiteral(node) || typescript_1.isNoSubstitutionTemplateLiteral(node);
};
exports.maybeNodeArray = function (nodes) { return nodes || []; };
...
exports.toTitleCase = function (value) {
    return value.replace(unicodeWordMatch, function (val) { return val[0].toUpperCase() + val.slice(1).toLowerCase(); });
};
